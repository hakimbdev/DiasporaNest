...
const RefundPolicy: React.FC = () => (
  <div className="max-w-3xl mx-auto py-16 px-4">
    ...
    <ul className="list-disc ml-6 mb-4">
      <li>Contact us at <a href="mailto:info@diasporanest.com" className="text-blue-600 underline">info@diasporanest.com</a> within 7 days of your payment.</li>
    ...
    <p>If you have any questions about our Refund Policy, please contact us at <a href="mailto:info@diasporanest.com" className="text-blue-600 underline">info@diasporanest.com</a>.</p>
  </div>
);
